...
impl RoomEvent {
    ...
    pub fn is_droppable(&self) -> bool {
        matches!(self, RoomEvent::SpeakingStarted { .. } | RoomEvent::SpeakingStopped { .. })
    }
}
...
mod tests {
    ...
    fn events_are_tagged_for_the_client() {
        let event = RoomEvent::SpeakingStarted { participant_id: ParticipantId::new() };
    ...
    fn every_event_names_its_subject() {
        ...
        let events = [
            ...
            RoomEvent::MicrophoneMuted { participant_id: p, by_moderator: true },
