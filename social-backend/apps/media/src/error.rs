...
use social_media_core::MediaCoreError;
use social_media_room::MediaRoomError;
use social_media_signaling::{ProtocolError, SignalCloseCode};
use thiserror::Error;
...
impl MediaError {
    ...
    pub fn close_code(&self) -> SignalCloseCode {
        match self {
            ...
            MediaError::HandshakeTimeout | MediaError::IdleTimeout => {
