 ...
 *
 * The wording is the *effect* of granting it rather than the key's name: "Allows
 * members to talk in voice channels" is what someone building a role needs to
 * know, and `speak` is not.
 *
 ...
 * goes unlisted, which is the failure worth being loud about. Order here is
 * presentational only: the API speaks in keys, never in bit positions.
 */
export const ALL_PERMISSIONS: ReadonlyArray<{
  ...
  { id: 'move_members', label: 'Move members', description: 'Disconnect or move people between channels.' },
  { id: 'manage_room', label: 'Manage channels', description: 'Create, edit and delete channels.' },
  { id: 'manage_community', label: 'Manage server', description: 'Edit the name, icon and description.' },
